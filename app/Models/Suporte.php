...
{ 
    ...
    {
        $parametros = "S INNER JOIN tb_empresas E ON E.EMP_COD=S.EMP_COD LEFT OUTER JOIN tb_usuarios_empresa U ON U.USU_COD=S.USU_COD OR U.USU_COD=S.USU_COD_DESTINATARIO WHERE S.EMP_COD={$this->codEmpresa} ORDER BY S.SUP_DT_CADASTRO;";
