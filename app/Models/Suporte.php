...
{ 
    ...
    {
        $parametros = "S INNER JOIN tb_empresas E ON E.EMP_COD=S.EMP_COD INNER JOIN tb_usuarios U ON U.USU_COD=S.USU_COD_DESTINATARIO OR U.USU_COD=S.USU_COD WHERE S.EMP_COD={$this->codEmpresa} AND S.SUP_STATUS=1 ORDER BY S.SUP_DT_CADASTRO";
